...
app.use('/api', matchmaker_1.matchmakerRouter);
describe('Matchmaker API', () => {
    beforeEach(() => {
        (0, matchmaker_1.resetMatchmaker)();
    });
